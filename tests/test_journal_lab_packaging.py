...
def test_journal_lab_has_a_separate_installation_identity() -> None:
    ...
    assert 'versionCode = 3' in lab_flavor.group("body")
    assert 'versionName = "3.0.0-journal-lab.3"' in lab_flavor.group("body")
...
def test_lab_release_is_immutable_verified_and_coinstallable() -> None:
    ...
    for required in (
        ...
        'test "$LAB_RELEASE_TAG" = "journal-lab-3"',
        ...
        "--notes-file docs/journal-lab-3.md",
        "--prerelease",
        "--verify-tag",
    ):
