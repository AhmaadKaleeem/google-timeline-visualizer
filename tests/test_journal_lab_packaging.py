...
def test_lab_release_is_immutable_verified_and_coinstallable() -> None:
    ...
    for required in (
        ...
        "EXPECTED_VERSION_NAME: 3.0.0-journal-lab.20",
        'test "$LAB_RELEASE_TAG" = "journal-lab-20"',
        ...
        'git worktree add --detach "$RUNNER_TEMP/previous-lab" c3b58c198459bfd1c09a9406e4b1892de19083fa',
        ...
        "--notes-file docs/journal-lab-20.md",
        "--prerelease",
        "--verify-tag",
    ):
