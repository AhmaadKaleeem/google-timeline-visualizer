# Timeline Visualizer 3.0.1

A patch release that finishes translating 3.0.0 and removes preset sharing.
...
3.0.0의 번역을 마무리하고 프리셋 공유를 제거한 패치 릴리스입니다.
...
3.0.0の翻訳を完成させ、プリセット共有を削除したパッチリリースです。
...
Una versión de mantenimiento que termina de traducir 3.0.0 y elimina la función de compartir ajustes.
...
Une version corrective qui termine la traduction de 3.0.0 et supprime le partage de préréglages.
...
Eine Fehlerbehebungsversion, die die Übersetzung von 3.0.0 abschließt und das Teilen von Voreinstellungen entfernt.
...
Uma versão de correção que conclui a tradução da 3.0.0 e remove o compartilhamento de predefinições.
